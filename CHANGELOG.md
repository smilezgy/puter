...
* Add system info (Client + Server metrics) ([#2311](https://github.com/smilezgy/puter/issues/2311)) ([bbe6f9d](https://github.com/smilezgy/puter/commit/bbe6f9dc2702da7436d77f08021d411c7eab25a5))
* **data-access:** move puter.js read to app driver ([2139551](https://github.com/smilezgy/puter/commit/2139551abf13569e4d0b998f764765dac1390ad8))
* **data-access:** move puter.js read to app driver ([f3100ec](https://github.com/smilezgy/puter/commit/f3100eca599598a60524d6d9c080bff139d04ca9))
* dynamo in oss ([#2195](https://github.com/smilezgy/puter/issues/2195)) ([a1689c4](https://github.com/smilezgy/puter/commit/a1689c4ea3372c2224cae159f530af74a51c2f15))
* give referrals ([#2262](https://github.com/smilezgy/puter/issues/2262)) ([d64bd21](https://github.com/smilezgy/puter/commit/d64bd21a99f02ae9fd69d7f66da9d102298d27c8))
* **gui:** add keyboard shortcuts guide dialog ([#2278](https://github.com/smilezgy/puter/issues/2278)) ([340d932](https://github.com/smilezgy/puter/commit/340d932ae16ecce99d8f56002f03ba41d9bedcf6))
* implement redirect for hosting base domain ([4d60168](https://github.com/smilezgy/puter/commit/4d60168d2f13633cc187fa7015d63ad7ac541472)), closes [#2214](https://github.com/smilezgy/puter/issues/2214)
* KV testing ([#2061](https://github.com/smilezgy/puter/issues/2061)) ([f6fa17a](https://github.com/smilezgy/puter/commit/f6fa17a57540a8e739b9a33b004536e17be9a395))
* kv.remove feature to remove nested elements or list indices ([#2258](https://github.com/smilezgy/puter/issues/2258)) ([f88ca5d](https://github.com/smilezgy/puter/commit/f88ca5d4bd49055ceef4b11591e2fdb6241c2e4c))
* MeteringService test fixes for now ([#2050](https://github.com/smilezgy/puter/issues/2050)) ([93eddd2](https://github.com/smilezgy/puter/commit/93eddd2238bab5fdf2d19b789895437bb4888449))
* meteringService test suite ([#2052](https://github.com/smilezgy/puter/issues/2052)) ([59e6418](https://github.com/smilezgy/puter/commit/59e6418b005abad03bbe06c895ed767606453c5a))
* method for updating users metering directly ([#2252](https://github.com/smilezgy/puter/issues/2252)) ([b1e7bc5](https://github.com/smilezgy/puter/commit/b1e7bc5fca8b93dae82d161a378ffba38f553bfc))
* more extension controller decorators ([#2272](https://github.com/smilezgy/puter/issues/2272)) ([cdb4226](https://github.com/smilezgy/puter/commit/cdb422659c3e58d508a5cd4fd8fc8c9d9300aa22))
* new kvstore operatios for more granular updates :rocket: ([#2254](https://github.com/smilezgy/puter/issues/2254)) ([23d7b75](https://github.com/smilezgy/puter/commit/23d7b751b92233dfb0e4f8d7c6a23f5c52db800e))
* paginated list ([#2296](https://github.com/smilezgy/puter/issues/2296)) ([f9888e6](https://github.com/smilezgy/puter/commit/f9888e67059be1eb98574a75f86c44b0491114f7))
* **puter.js:** make home directory default cwd ([c715057](https://github.com/smilezgy/puter/commit/c715057065670270edd215bbb58e7676a8e625a5))
* rawBody parser, user  metadata column + other misc fixes ([#1904](https://github.com/smilezgy/puter/issues/1904)) ([5ff8c7e](https://github.com/smilezgy/puter/commit/5ff8c7e0409f0427293c676213608309824af549))
* refactor ai to have single entry point and follow defined model structure ([#2114](https://github.com/smilezgy/puter/issues/2114)) ([e2ae313](https://github.com/smilezgy/puter/commit/e2ae3135893d979af40606429dfc150331c4e864))
* rename ai models to match norm ([#2121](https://github.com/smilezgy/puter/issues/2121)) ([9da8aa0](https://github.com/smilezgy/puter/commit/9da8aa08493d9d85b1406f68a09caf1d1f7a65ab))
* Settings and modal UI/UX improvements ([#1828](https://github.com/smilezgy/puter/issues/1828)) ([1919163](https://github.com/smilezgy/puter/commit/191916321be77502f77927a005edbb103f92a599))
* single image ai endpoint ([#2129](https://github.com/smilezgy/puter/issues/2129)) ([161ca74](https://github.com/smilezgy/puter/commit/161ca74aa3d55be5bd1db11b40a1343aa046e663))
* support extension divs headers and tags being inserted to puter homepage load ([#2221](https://github.com/smilezgy/puter/issues/2221)) ([6cc86ff](https://github.com/smilezgy/puter/commit/6cc86ff58b5641ca30b1a9475abf65073a6a1c88))
* usage endpoints, allow appName ([#2303](https://github.com/smilezgy/puter/issues/2303)) ([3579753](https://github.com/smilezgy/puter/commit/35797536bace5e77b90b4edcd8cdfe98ef4ec4fd))


### Bug Fixes

* access internal ID without assuming fetch ([a44e1fc](https://github.com/smilezgy/puter/commit/a44e1fc0743948203139781e1968c77012c34914))
* add back test ([#2317](https://github.com/smilezgy/puter/issues/2317)) ([fbe8736](https://github.com/smilezgy/puter/commit/fbe87369f5fea9241b5ee7b3a0b86e1133f2161f))
* add catch all for minimum usage amounts ([#2248](https://github.com/smilezgy/puter/issues/2248)) ([2ef9aa3](https://github.com/smilezgy/puter/commit/2ef9aa3fb1abe5e3f08ce9a247085a411c039d04))
* Add debounce to toolbar reveal when dragging windows to prevent accidental activation ([#1989](https://github.com/smilezgy/puter/issues/1989)) ([f6139bc](https://github.com/smilezgy/puter/commit/f6139bc79aa4dd1c08ad0659b540c7f22136bb37))
* add missing 'tel' runtime module ([6d36c90](https://github.com/smilezgy/puter/commit/6d36c900328165d122edb5bfe2a5e3ca1f2a4c05))
* add missing Context import to IconResult ([71a2615](https://github.com/smilezgy/puter/commit/71a26156bd6dc9075b4b24fb24d41cf9b7170a48))
* add missing ref to `next()` ([5062e3c](https://github.com/smilezgy/puter/commit/5062e3c5ed6e33f80b9086473f1eb2d7e859cf9a))
* add simple 30s cache to /healthcheck ([cb7c83f](https://github.com/smilezgy/puter/commit/cb7c83f67024c3af4cb127f0717838d39e74dc66))
* adding more benign changes ([#1891](https://github.com/smilezgy/puter/issues/1891)) ([85432c8](https://github.com/smilezgy/puter/commit/85432c886e838b9e2012dc08440e4b81b5d0a428))
* allow mysql json object response ([#1918](https://github.com/smilezgy/puter/issues/1918)) ([0fd7100](https://github.com/smilezgy/puter/commit/0fd7100795619a667c2351cf559a0d4e208a9e4f))
* also check this.entry.id when checking mysql_id ([cc7369d](https://github.com/smilezgy/puter/commit/cc7369d9d71b72b97929a2f1387c4f006bab5832))
* attempt coercion to fix vscode corruption ([5e4dfbc](https://github.com/smilezgy/puter/commit/5e4dfbc963b1af2b70475bca454b077c365e2abc))
* backend tests breaking with permision ([#2067](https://github.com/smilezgy/puter/issues/2067)) ([cea94d1](https://github.com/smilezgy/puter/commit/cea94d16cbcdc2185b66feaf225c28647c9d95fb))
* **backend:** fix context dual-instance problem ([b17486b](https://github.com/smilezgy/puter/commit/b17486b1b449b162e3a6da5ca6f58a75c78a9f28))
* **backend:** handle ll_mkdir exists race condition ([f125830](https://github.com/smilezgy/puter/commit/f125830fba654e21ccd1c2642864e2d20455ba5d))
* **backend:** race condition in hashing_stream ([8e418a1](https://github.com/smilezgy/puter/commit/8e418a11a11993172c2abaa5c2f33c4728235842))
* **backend:** singleton in helpers for testability ([be8b5ef](https://github.com/smilezgy/puter/commit/be8b5ef70adf60c707d1bc9cafda006e0baaa2ce))
* **backend:** status code check and handle HLMkdir ([21d02e7](https://github.com/smilezgy/puter/commit/21d02e7dae05f10489fc7a94506e7615676892b3)), closes [#1603](https://github.com/smilezgy/puter/issues/1603)
* **backend:** update protected app perm implicator ([79fda7b](https://github.com/smilezgy/puter/commit/79fda7b8c21477fa9dfa641497a632afe5accb93))
* bad ai calls ([#2144](https://github.com/smilezgy/puter/issues/2144)) ([9e2ae1c](https://github.com/smilezgy/puter/commit/9e2ae1c004103aa7537f06073f9b1d97c48ff7b1))
* bad caching query crashing our db ([#2172](https://github.com/smilezgy/puter/issues/2172)) ([25221e5](https://github.com/smilezgy/puter/commit/25221e539d1f9111180babd750448f4e266415dd))
* bad export ([a397707](https://github.com/smilezgy/puter/commit/a397707c7bf86153a611e7ca8045028c8854176a))
* bad method name for together ai ([#2128](https://github.com/smilezgy/puter/issues/2128)) ([1a0e2d3](https://github.com/smilezgy/puter/commit/1a0e2d3def174ea4073087fb169d01f495a1680f))
* bad usageType ([#2157](https://github.com/smilezgy/puter/issues/2157)) ([f3e143e](https://github.com/smilezgy/puter/commit/f3e143e74a5cec6016cde7bb619e12cd9f350dc3))
* bad wrapper wrap ([#1908](https://github.com/smilezgy/puter/issues/1908)) ([490cd45](https://github.com/smilezgy/puter/commit/490cd4533646c64058645ca8ca861d43a49914d5))
* batch app info referral ([#2146](https://github.com/smilezgy/puter/issues/2146)) ([aa225e3](https://github.com/smilezgy/puter/commit/aa225e3049b86e47941e3cc2088fff29a3bfafbc))
* batch fetch get apps for launch apps and recommended apps ([#2315](https://github.com/smilezgy/puter/issues/2315)) ([6e9e537](https://github.com/smilezgy/puter/commit/6e9e5371c874cb4508ed6f2546ead405c95a97fe))
* cache get_app result with expiry to lessen load on db ([#2229](https://github.com/smilezgy/puter/issues/2229)) ([174e613](https://github.com/smilezgy/puter/commit/174e6130ee7fd4337cdcc21613dc1485d7e745e1))
* check if system_prompts is an empty array ([d7ea676](https://github.com/smilezgy/puter/commit/d7ea6769cb47a97ccf4b743e343ea42712eab0cd))
* **data-access:** add guard for app actors ([1e3b704](https://github.com/smilezgy/puter/commit/1e3b704ea8606487692e5d6700f360dba6016007))
* **data-access:** read response regression ([768a35e](https://github.com/smilezgy/puter/commit/768a35e9b58219c41d4a2fad4f683cee09413812))
* dedup get_apps app requests ([#2325](https://github.com/smilezgy/puter/issues/2325)) ([d3a27be](https://github.com/smilezgy/puter/commit/d3a27be88e0b52f16456f06b2a7c485fded705db))
* desktop_items in whoami ([7b38131](https://github.com/smilezgy/puter/commit/7b38131b65ddd415a15f68918482aa339a2926ea))
* disable bad token checks? ([#2326](https://github.com/smilezgy/puter/issues/2326)) ([d42f9b0](https://github.com/smilezgy/puter/commit/d42f9b0e1057bd5d6c617a76c8493196c8676e35))
* disable requests from server in two services ([de77b11](https://github.com/smilezgy/puter/commit/de77b11954db3a30fc1f2fc2e41d14cce1c49dc8))
* don't cache nor fetch raw b64 url for app icons ([#2230](https://github.com/smilezgy/puter/issues/2230)) ([f3b5e1b](https://github.com/smilezgy/puter/commit/f3b5e1b03f233dda757c283626ead7865c2a97a4))
* don't load bench.js files ([#2207](https://github.com/smilezgy/puter/issues/2207)) ([91e12f6](https://github.com/smilezgy/puter/commit/91e12f68866e731e19db83bd6ecd359ab9779906))
* downgrade opentelemetry so it works again ([1d7a5b7](https://github.com/smilezgy/puter/commit/1d7a5b7c588397090552fd344c19f89824367c17))
* eleven labs metering costs ([#2112](https://github.com/smilezgy/puter/issues/2112)) ([910e604](https://github.com/smilezgy/puter/commit/910e6041fa86266165e5647a91238721c5950572))
* Enable godmode for dev-center to open worker files in editor ([#2224](https://github.com/smilezgy/puter/issues/2224)) ([677426c](https://github.com/smilezgy/puter/commit/677426cbe7868c4fe4b5da1e980568f5507dc36c))
* error calling .startsWith on null mime_type ([656a01f](https://github.com/smilezgy/puter/commit/656a01f2fab7fc04851bcbca534cbbe882b707cd))
* eslint autofixable errors ([#2002](https://github.com/smilezgy/puter/issues/2002)) ([11e0575](https://github.com/smilezgy/puter/commit/11e057557dc593f3ca6a18c363b0880acb60b255))
* explicit actor not passed to fs provider ([3aadaf8](https://github.com/smilezgy/puter/commit/3aadaf84203f3a042ba67d2b66ffee1a631bdf22))
* fallback models ([#2005](https://github.com/smilezgy/puter/issues/2005)) ([262b359](https://github.com/smilezgy/puter/commit/262b3596331ed98371bf68d0b0b94e281d8d4284))
* fsNode.is() requiring unnecessary fetch ([3fe6b8d](https://github.com/smilezgy/puter/commit/3fe6b8d23a786b45e351972e32bf40ae37926f2b))
* get subdomains permission working ([237dc2e](https://github.com/smilezgy/puter/commit/237dc2ef9a91e74e2979d5a7caad22efe67df8c9))
* header resend issue with catch-all handler ([a8dc62e](https://github.com/smilezgy/puter/commit/a8dc62ef80e470243933055c84353c243897abd3))
* husky ([#2260](https://github.com/smilezgy/puter/issues/2260)) ([13f7d7b](https://github.com/smilezgy/puter/commit/13f7d7b5028994106a6f0fa9c2b0e770691cc189))
* **i18n:** complete and clean up German translation ([#1893](https://github.com/smilezgy/puter/issues/1893)) ([4e91774](https://github.com/smilezgy/puter/commit/4e91774b9597e75196792c5ce90992b61d4826c1))
* id2path import ([fb41eaa](https://github.com/smilezgy/puter/commit/fb41eaae23cdd7bf6af5a14284b0f497099e0ff8))
* import issues on run form benchmarks (somehow) ([c43f399](https://github.com/smilezgy/puter/commit/c43f3990d9b1ebda448a6288b5c732f68a08a4f7))
* improve response error handling in Perms module ([11a1807](https://github.com/smilezgy/puter/commit/11a18078be78aef5ded5fcc5d87700e0bdbf50d5))
* inaccurate error on update of non-existing ([cf9a867](https://github.com/smilezgy/puter/commit/cf9a867190bc938133936bf5e7b3018cd1c87472))
* incorrect implementation of ll_mkdir ([6a2cac5](https://github.com/smilezgy/puter/commit/6a2cac5d573138779aeedea3f4e43882c9640ed9))
* incorrect variable ref in hl_move for shared ([d429d2f](https://github.com/smilezgy/puter/commit/d429d2f5bc355a75ab070e141c2d743b563a7383))
* issues creating shortcuts ([a5bbc7e](https://github.com/smilezgy/puter/commit/a5bbc7e95b6d8fb559827813df59c6ce06deab57)), closes [#2200](https://github.com/smilezgy/puter/issues/2200)
* log format ([#2333](https://github.com/smilezgy/puter/issues/2333)) ([2402e49](https://github.com/smilezgy/puter/commit/2402e49cce12c91d5da652ef22708d4592be6ac3))
* make cache calls async on boot ([#2173](https://github.com/smilezgy/puter/issues/2173)) ([6652a1d](https://github.com/smilezgy/puter/commit/6652a1d33259647762468b9795b8c3e05948ae15))
* metering service alerts + missing claude costs ([#2058](https://github.com/smilezgy/puter/issues/2058)) ([f120bc9](https://github.com/smilezgy/puter/commit/f120bc9c584879a423d3f6b04e55ae9c68ff8ecb))
* minor issue in root package.json ([d665149](https://github.com/smilezgy/puter/commit/d6651498eb39d247bba32ca71a59dcd14f80de32))
* missing published/attached website icon for folder on different views ([#1764](https://github.com/smilezgy/puter/issues/1764)) ([#1945](https://github.com/smilezgy/puter/issues/1945)) ([2b8081d](https://github.com/smilezgy/puter/commit/2b8081d10087a5b668f315f1db3b56e8bfdb7175))
* missing video gen ai services in ai module ([#2180](https://github.com/smilezgy/puter/issues/2180)) ([54dd60d](https://github.com/smilezgy/puter/commit/54dd60d44bddbee23443f81085a9d3010cdaf211))
* more reliable 404 responses for `.api` endpoint ([e744333](https://github.com/smilezgy/puter/commit/e7443338fba241b3eacd425b94ef1c14ceee08ad))
* more strict metering limits, disable ambigious openrouter one ([#2249](https://github.com/smilezgy/puter/issues/2249)) ([7f76bff](https://github.com/smilezgy/puter/commit/7f76bff3f35827cfa8f8c196add7bb4bad0fd3e3))
* move dependency in LocalDiskStorageController ([bb90595](https://github.com/smilezgy/puter/commit/bb90595431c67d7a686b5a0d76ace0efbbf9a69e))
* normalize file object in `/writeFile` ([f9a3e86](https://github.com/smilezgy/puter/commit/f9a3e86fe939a3fda5ee3273d829f4396d47c3a6))
* only fallback to models that are immediately the same ([#2001](https://github.com/smilezgy/puter/issues/2001)) ([f177397](https://github.com/smilezgy/puter/commit/f1773974c068155002c7b7aefc69c0f652210f9c))
* only rate limit login when failed ([#2355](https://github.com/smilezgy/puter/issues/2355)) ([cc5285f](https://github.com/smilezgy/puter/commit/cc5285f88aae1f2d047d474db7d3062f41e8855a))
* open router cache token metering ([#1988](https://github.com/smilezgy/puter/issues/1988)) ([02d95db](https://github.com/smilezgy/puter/commit/02d95db7edfbc6ff84ca8eaa8fae506a801fb8df))
* openrouter costs always being 0 ([#2250](https://github.com/smilezgy/puter/issues/2250)) ([754e820](https://github.com/smilezgy/puter/commit/754e82040379cc855b8eacf961eb41358797aef1))
* openrouter missing usage ([#2008](https://github.com/smilezgy/puter/issues/2008)) ([85d13a9](https://github.com/smilezgy/puter/commit/85d13a9d4b7ed7578494a3f84b11ff3f78173b7b))
* oss boot error fixes ([#2039](https://github.com/smilezgy/puter/issues/2039)) ([001e174](https://github.com/smilezgy/puter/commit/001e174b81aa77a8a8f2c2f758da6cb15a26881f))
* pass exporter to NodeSDK constructor ([87dbb34](https://github.com/smilezgy/puter/commit/87dbb34a8d1c1774cae8f48165619fe0dade11b3))
* **perms:** fix revokePermission for "flat" impl ([a85d2b7](https://github.com/smilezgy/puter/commit/a85d2b7098600769cae9f0d993c1c8763d17c87e))
* possible undefined when handling stuck stream ([813ea63](https://github.com/smilezgy/puter/commit/813ea63d21b345a78ac8046384293833ec3bf7a4))
* prevent loop if failing ai models? ([#2122](https://github.com/smilezgy/puter/issues/2122)) ([8d52cef](https://github.com/smilezgy/puter/commit/8d52cefe476a5401ddb9d65573417953f86e736f))
* **puter.js:** check for uuid before relative path ([3da3181](https://github.com/smilezgy/puter/commit/3da318129cd2b9bb42e379854ed2f01650206ce9))
* **puterfs:** use node `crypto` instead of Web API ([8eee9ad](https://github.com/smilezgy/puter/commit/8eee9ad1dfdb476b4b52d7af214a7e40a33bd507))
* references to `global_config` in puterfs ([705901f](https://github.com/smilezgy/puter/commit/705901fd2b8ffce2d5de49f139ead52863e7250e))
* requestPermission Promise never settled ([3ea309e](https://github.com/smilezgy/puter/commit/3ea309e93b76b815de60bdbfb79e72ea0bf34038))
* rm another ref to storage, rm dupe meter ([db8f45f](https://github.com/smilezgy/puter/commit/db8f45f3867462ffd9932b85334679489250f18a))
* shard app usages properly by user ([#2279](https://github.com/smilezgy/puter/issues/2279)) ([0b98638](https://github.com/smilezgy/puter/commit/0b9863814c00637ffdade4331639e34bb325d846))
* size_measure_stream in streamutils ([92d03e5](https://github.com/smilezgy/puter/commit/92d03e55014a6c5bc5d9c492783f6b0455cfa3d7))
* skip cache when checking user:&lt;&gt;:email:read ([ef6dea2](https://github.com/smilezgy/puter/commit/ef6dea2bec1b082e764a90cacf3893bb6c39674b))
* skip CI tests when only docs are changed ([#2335](https://github.com/smilezgy/puter/issues/2335)) ([#2338](https://github.com/smilezgy/puter/issues/2338)) ([7045452](https://github.com/smilezgy/puter/commit/70454521ef36aab085ad1562fe040a681e46f7ea))
* stricten undef checks ([#2082](https://github.com/smilezgy/puter/issues/2082)) ([cce2c4a](https://github.com/smilezgy/puter/commit/cce2c4ac27b15c506dcec414f94786f1242808e8))
* suggested apps breaking ([#2343](https://github.com/smilezgy/puter/issues/2343)) ([66a3af6](https://github.com/smilezgy/puter/commit/66a3af69c928f1f4b8741fe04464df8193ffccd7))
* TelemetryService ([#2077](https://github.com/smilezgy/puter/issues/2077)) ([3c579dc](https://github.com/smilezgy/puter/commit/3c579dcc0d971327a49d9cf290decedbdee8329d))
* together ai image prices ([#2130](https://github.com/smilezgy/puter/issues/2130)) ([04c8b06](https://github.com/smilezgy/puter/commit/04c8b06616c703fba45dce8e6ee1f49c3040e4f2))
* ts extensions ([#2247](https://github.com/smilezgy/puter/issues/2247)) ([93afbe4](https://github.com/smilezgy/puter/commit/93afbe4dd9f8928ba750c6e7eba80fab0360dfd4))
* ts issue when building for deploy ([#1890](https://github.com/smilezgy/puter/issues/1890)) ([11d2515](https://github.com/smilezgy/puter/commit/11d2515cb283bba0cf9d12610170d9b751d28f20))
* tsconfig to ignore vite config files ([#2048](https://github.com/smilezgy/puter/issues/2048)) ([cb66c56](https://github.com/smilezgy/puter/commit/cb66c56a6b39f82cf620506f1c1d77965d6c54c3))
* types and tests? ([#2193](https://github.com/smilezgy/puter/issues/2193)) ([a661752](https://github.com/smilezgy/puter/commit/a6617527dbcdaee4816bfe8cf76f2d0372012496))
* typo in dbkvStore ([#2066](https://github.com/smilezgy/puter/issues/2066)) ([e8f00e1](https://github.com/smilezgy/puter/commit/e8f00e112175079ef1573b9235c0c8cd3ff94bca))
* undefined svc_fs ([e735705](https://github.com/smilezgy/puter/commit/e7357054b085e62998f6bede0a054efce4161e85))
* update import in TestService ([e95b0be](https://github.com/smilezgy/puter/commit/e95b0be371f49bd3baed02dc3d0a7d41fe3e2065))
* update MeteringService and add utility for TestKernel ([5f78552](https://github.com/smilezgy/puter/commit/5f785520055a08f55add98510b01cfa000d50a26))
* update validation for permission endpoints ([06d56fd](https://github.com/smilezgy/puter/commit/06d56fd7116a874362a6ecd9bd619702d96fce1c))
* wrong order for telemetery init ([#2078](https://github.com/smilezgy/puter/issues/2078)) ([d3beac0](https://github.com/smilezgy/puter/commit/d3beac0518e214f67a391ae0507d06ba7a3f44f5))
* x86 not booting locally ([#1959](https://github.com/smilezgy/puter/issues/1959)) ([849beec](https://github.com/smilezgy/puter/commit/849beecd4fea614334cfa1004e4b5f6a0dfb2cf1))


### Performance Improvements

* [+] readdirstat_uuid optimized implementation ([9bac2cb](https://github.com/smilezgy/puter/commit/9bac2cba07e65c8a75438fcc8b3d6a3104b1485b))
* batch readdir suggested apps into single big query ([#2332](https://github.com/smilezgy/puter/issues/2332)) ([2287704](https://github.com/smilezgy/puter/commit/228770410293acaa92b76e67e9480a17f1e22139))
* condition for re-fetch in fsNode.exists() ([4b31204](https://github.com/smilezgy/puter/commit/4b31204224d6e46de1a4c32aa471f0ab24079355))
* dedup and cache get_apps in puter gui, also add more app batching in backend ([#2319](https://github.com/smilezgy/puter/issues/2319)) ([e9631b5](https://github.com/smilezgy/puter/commit/e9631b5a04b3f7672d70a124751872aef10b1f9b))
* don't await on modifying 'accessed' ([af9a2b8](https://github.com/smilezgy/puter/commit/af9a2b830061d8c7531aa01ecdd1f4c5928b6bd3))
* don't fetch b64 icon for apps always, and lru suggestedApps ([#2336](https://github.com/smilezgy/puter/issues/2336)) ([8bb4dec](https://github.com/smilezgy/puter/commit/8bb4dec231fade34ff4d551df2daad6db50510c9))
* **es:** generate client-safe objects in parallel ([7228e63](https://github.com/smilezgy/puter/commit/7228e63c8bf4ffefe03a7aa115081fe353314d0a))
* improve parallelization in SQLES ([6edd7de](https://github.com/smilezgy/puter/commit/6edd7debb8198f3846954e347196f829ff0e3863))
* improve tel + decrease logs ([#2309](https://github.com/smilezgy/puter/issues/2309)) ([4e6d9c9](https://github.com/smilezgy/puter/commit/4e6d9c9f336b25d0a012b968024ee9dde01a584d))
* is()/is_above() determine when to fetch ([6c0daf5](https://github.com/smilezgy/puter/commit/6c0daf58c41f81769ccd40f5588fca3ee36834d3))
* make app entries more scalable, avoid writing global entries since its just puter itself and isn't relevant ([#2233](https://github.com/smilezgy/puter/issues/2233)) ([aafdec9](https://github.com/smilezgy/puter/commit/aafdec9b8163c1ab437cda6bb0cc0b433e4c4351))
* more benchmarks ([d3c1fc3](https://github.com/smilezgy/puter/commit/d3c1fc31035eba74aff516723389febecf8f870a))
* more benchmarks (2) ([2c60faf](https://github.com/smilezgy/puter/commit/2c60faf5166f7a1857e69a17125909ac8995deed))
* split implied user-app permissions ([eea9d8b](https://github.com/smilezgy/puter/commit/eea9d8b27e7b5bfe8839c4baca33693f4b118ed7))


### Reverts

* change to ai model names ([#2123](https://github.com/smilezgy/puter/issues/2123)) ([b40ca1d](https://github.com/smilezgy/puter/commit/b40ca1df2c8de867af81af4d8fb8e6ccf3a82380))
* single ai image entry point ([#2131](https://github.com/smilezgy/puter/issues/2131)) ([907d0db](https://github.com/smilezgy/puter/commit/907d0db32897323a07721c87c6f1b27e60b44b22))
